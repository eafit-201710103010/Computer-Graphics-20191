 ...
 * para implementar la cámara virtual
 *
 * @version 10/02/2019
...
class CasitaDib extends JPanel
    ...
    private static final String FILENAME = "C:\\Users\\luisa\\Documents\\NetBeansProjects\\Transformaciones\\src\\transformaciones3D\\casita.txt\\";
    // ArrayList de los puntos inciiales de la figura
    private static final ArrayList<Point3> puntos = new ArrayList<>();
    //ArrayList de tipo Edge que representan las lineas que componen el objeto
    private static final ArrayList<Edge3D> edgesCasita = new ArrayList<>();
    //ArrayList de tipo Edge3D que representa las lineas a ser dibujadas desde el punto de vista d ela cámara
    ...
    //Angulos de ubicación de la cámara
    double phi = 0;
    double tetha = 0;
...
//        g2d.draw(ejex);
//        g2d.draw(ejey);
        //La tabla de surf se dibujara en morado
        g2d.setColor(new Color(172, 4, 172));

        //Leer el archivo de texto y dibujo inicialmente
        if (!leido) {
            leerArchivo(g2d);
            vistaCamara(g2d);
        }
    ...
    /**
     * Método que lee un txt y dibuja un objeto según las coordenadas que este describa
     */
    ...
    /**
     * Método que aplica la matriz de tranformación para mover el objeto
     */
    ...
    /**
     * Método que aplica la matriz de tranformación para rotar un objeto
     */
    ...
    /**
     * Método que escala en los diferentes ejes el objeto
     */
    ...
    /**
     * Método que cambia la ubicación de la cámara 
     */
    public void rotarCamara(Graphics2D g2d, int dir) {
        //Según la dirección aumento los angulo que determinan la posición de la cámara
        switch (dir) {
            case 1:
                tetha-=10;
                break;
            case 2:
                ...
                break;
            case 3:
                //Angulo minimo de Phi es -90, bajo de a 10 grados hasta que esté en -80, de ahí bajo lo que falte hasta -89
                if (phi > -79) {
                    phi -= 10;
                }else if (phi>-89){
                    phi-= 89+phi;
                ...
                break;
            case 4:
                //Angulo máximo de Phi es 90, subo de a 10 grados hasta que esté en 80, de ahí subo lo que falte hasta 89
                if (phi < 79) {
                    phi += 10;
                }else if (phi<89){
                    phi+=(89-phi);
    ...
    /**
     * Método que genera una versión "Virtual" de el objeto que es la que se dibuja 
     * cuado se ve a través de la cámara
     * @param g2d Librería Graphics
     */
    ...
    /**
     * Método que halla el centroide de un objeto y lo mueve al origen para su posterior rotación o escalamiento
     */
    ...
    /**
     * Método que devuelve on objeto tranformado en el centro a su posición original
     */
    ...
    /**
     * Método que aleja o acerca el plano de proyección de un sistema de coordenadas
     */
    ...
    /**
     * Método que aplica la matriz de proyección y dibuja 
     */
    ...
    /**
     * Método que convierte los puntos a coordenadas del panel y los dibuja
     */
    ...
    /**
     * Método que multiplica cada punto de la figura por una matriz de transformación
     * @param trans Matriz de transformación 
     */
    ...
    /**
     * Matriz que multiplica cada punto por la matriz que mueve el objeto y la camara al origen y guarda los puntos
     * transformados en edgesDibujados, para no afectar las coordenadas originales del objeto
     * @param trans Matriz de tranformación
     */
     private void multCam(Matrix4x4 trans) {
        ...
        for (Edge3D lineae : edgesCasita) {
            ...
            //Creo una lueva liea y lo agrego a edgesDibujados, conservando edgesCasita igual
            Point3 a = new Point3(in1.x, in1.y, in1.z, in1.w);
